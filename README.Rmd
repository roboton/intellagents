...
You can install the released version of intellagents from [CRAN](https://CRAN.R-project.org) with:
...
```{r fig.height=8, fig.width=8, out.width="100%", fig.align="center"}
time_periods <- 30 
...
For a larger version of the final plot, click [here](https://ond3.com/multiagent_demo.html).
